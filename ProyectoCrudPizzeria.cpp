...
void agregarPedido(vector<Pedido>& pedidos) {
    ...
    while (true) {
        ...
        cout<<"1.- Combo Estrella de Freddy: 1 pizza de pepperoni con extra de queso    ---> $9.99" << endl;
        cout<<"2.- Combo Tropical de Chica: 1 pizza hawaiana + 1 refresco de naranja   ---> $8.50" << endl;
        cout<<"3.- Combo Verde de Bonnie: 1 pizza vegetariana + 1 batido de fresa  ---> $10.25" << endl;
        cout<<"4.- Combo Explosivo de Foxy: 1 pizza picante + 1 bebida energetica      ---> $11.75" << endl;
        cout<< "Ingresa una opcion: "; cin >> opcion;
        p.numero = pedidos.empty() ? 1 : pedidos.back().numero + 1;
        switch (opcion) {
            case 1: p.descripcion = "Combo Estrella de Freddy"; p.precio = 9.99; break;
            case 2: p.descripcion = "Combo Tropical de Chica"; p.precio = 8.50; break;
            case 3: p.descripcion = "Combo Verde de Bonnie"; p.precio = 10.25; break;
            case 4: p.descripcion = "Combo Explosivo de Foxy"; p.precio = 11.75; break;
...
void facturar(vector<Pedido>& pedidos) {
    ...
    while (true) {
        cout << "\nSeleccione su forma de pago" << endl;
